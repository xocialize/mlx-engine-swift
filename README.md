...
>
> MLXEngine is **published and consumable**: tagged **v0.38.0** (capability contract **1.29.0**),
> and already serving **41 published model packages** (59 tracked, incl. WIP + research — see
